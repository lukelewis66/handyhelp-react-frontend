...
const SearchListingsList = ({ selectedFilters }) => {
    const fakeListingItems = [
        ...
        { description: "description 2", image: "image 2", skilltags: "fake skilltags 2", LID: "3PV173J75WpJdvQEaUVO" },
        { description: "description 3", image: "image 3", skilltags: "fake skilltags 3", LID: "BTEoziy9gwbDoawduYt5" },
        { description: "description 4", image: "image 4", skilltags: "fake skilltags 4", LID: "Dg48GlazHo7rYmyempMW" },
    ];
    return (
